...
//		"bgcolor_override"	"0 0 0 240"
	...
	"RankModelPanel" //// Casual or competitive badge ^MedalButton is misplaced.. its not centered on casual/competitive medal, whats happening?? its literally placed on left side of medal^
	{
	...
	"RankBorder" //// Rank border for casual or competitive Default: wide=260 tall=60
	{
	...
	"FriendsContainer" /////To have a border in friends list, here's default tf2 border... "border"		"MainMenuBGBorder"
	{
		"ControlName"	"EditablePanel"
		...
		"TitleLabel" ////Default: font = HudFontSmallBold, you can change the font but needed a new one please watch guides how to add fonts to tf2
		{
			"ControlName"	"CExLabel"
